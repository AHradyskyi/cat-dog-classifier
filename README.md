...
The learning dataset was taken from this [Kaggle page](https://www.kaggle.com/datasets/bhavikjikadara/dog-and-cat-classification-dataset). The original data contains 12.5k images in both categories. Due to resource constraints, it was reduced to 1.2k images.
